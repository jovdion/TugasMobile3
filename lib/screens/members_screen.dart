...
class MembersScreen extends StatelessWidget {
  ...
  final List<Member> members = const [
    Member(
      ...
      instagram: 'ridhoabadii',
      linkedin: 'daniel-ridho-abadi-b99627293/',
      github: 'danielridho',
    ),
    Member(
      name: 'Hadyan Baktiadi', 
      role: '123220090', 
      imgUrl: './assets/hadyan.jpg',
      instagram: 'hadyan_baktiadi',
      linkedin: 'hadyan-baktiadi-167564302',
      github: 'hadyanbakti',
    ),
    Member(
      name: 'Jovano Dion Manuel', 
      role: '123220103', 
      imgUrl: './assets/dion.jpg',
      instagram: 'jovdion_',
      linkedin: 'jovano-dion-manuel-219b91315',
      github: 'jovdion',
    ),
  ];
